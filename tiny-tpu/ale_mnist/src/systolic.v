...
module systolic #(
    ...
    input wire        sys_start,       // start signal
    ...
    input wire sys_accept_w_1,             // accept weight signal propagates only from top to bottom in column 1
    input wire sys_accept_w_2,             // accept weight signal propagates only from top to bottom in column 2

    input wire sys_switch_in,               // switch signal copies weight from shadow buffer to active buffer. propagates from top left to bottom right
