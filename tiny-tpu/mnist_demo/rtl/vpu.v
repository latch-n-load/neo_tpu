...
module vpu (
    ...
    input wire [3:0] vpu_data_pathway, // 4-bits to signify which modules to route the inputs to (1 bit for each module)
    ...
    // Inputs from UB
    input wire signed [15:0] bias_scalar_in_1,             // For bias modules
    input wire signed [15:0] bias_scalar_in_2,             // For bias modules
    input wire signed [15:0] lr_leak_factor_in,            // For leaky relu modules
    input wire signed [15:0] Y_in_1,                       // For loss modules
    input wire signed [15:0] Y_in_2,                       // For loss modules
    input wire signed [15:0] inv_batch_size_times_two_in,  // For loss modules
    input wire signed [15:0] H_in_1,                       // For leaky relu derivative modules
    input wire signed [15:0] H_in_2,                       // For leaky relu derivative modules
